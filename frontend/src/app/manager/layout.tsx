...
import { LayoutDashboard, Users, LogOut, ShieldCheck, ClipboardCheck, AlertTriangle, Smartphone } from 'lucide-react';
...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: 'Inspections', href: '/manager/inspections', icon: ClipboardCheck },
    { name: 'Incidents', href: '/manager/incidents', icon: AlertTriangle },
    { name: 'Inspectors', href: '/manager/inspectors', icon: Users },
    { name: 'Managers', href: '/manager/managers', icon: ShieldCheck },
    { name: 'Devices', href: '/manager/devices', icon: Smartphone },
  ];
      ...
      <div className="w-full lg:w-64 bg-slate-900 text-white lg:min-h-screen flex flex-col">
        <div className="p-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg tracking-tight">Manager Portal</span>
          </div>
        </div>
